...
# Le signal electrique est envoyé à la pin 25 afin d'allumer les LEDS infrarouges
...
# Nous coupons le signal electrique envoyé à la pin 25, les LEDS s'éteignent    
